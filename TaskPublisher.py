...
axs[0].plot(xAxis, report2['losses'], label='Coded')
axs[0].plot(xAxis, report1['losses'], label='Joint')
...
axs[1].plot(xAxis, report2['accs'], label='Coded')
axs[1].plot(xAxis, report1['accs'], label='Joint')
...
taskPublisher1.plot_table(axs[2])
axs[1].set_title('Coded')
taskPublisher2.plot_table(axs[1])
